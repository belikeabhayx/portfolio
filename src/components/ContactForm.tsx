                            ...
                            {({
                              ...
                              <>
                                <input
                                  ...
                                  type="text"
                                  placeholder="Email"
                                  className="w-full rounded-lg border-none bg-teal-50 font-semibold text-teal-800 caret-black placeholder:font-normal placeholder:text-zinc-400 focus-within:border-2 focus-within:border-teal-600 focus-within:ring-teal-600"
                                />
